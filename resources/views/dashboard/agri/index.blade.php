...
<div class="row">
    <div class="col card w-50">
        ...
        <h1 class="text-center m-3">List Pertanian dan Peternakan</h1>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Data Pertanian dan Peternakan</h5>
                    ...
                    <form action="{{route('admin.storeAgri')}}" method="post">
                        ...
                        <div class="modal-body bg-white">
                            <div class="form-group m-3">
                                <label for="">Nama Pertanian/Peternakan</label>
                            ...
                            <div class="form-group m-3">
                                <label for="">Kecamatan Pertanian/Peternakan</label>
                            ...
                            <div class="form-group m-3">
                                <label for="">Nama Produksi Pertanian/Peternakan</label>
                            ...
                            <div class="form-group m-3">
                                <label for="">Rata-Rata Produksi Per Tiga Bulan</label>
        ...
        <div class="m-3 p-3">
            <table class="display" id="table1">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Nama Pertanian/Peternakan</th>
                        <th>Keterangan</th>
                        <th>Nama Provinsi</th>
                        <th>Nama Kota</th>
                        <th>Nama Kecamatan</th>
                        <th>Nama Produksi Pertanian/Peternakan</th>
                        <th>Satuan Unit</th>
                        <th>Rata-Rata Produksi Per Tiga Bulan</th>
                        <th>Jenis</th>
                        <th>Aksi</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <div class="modal fade" id="edit{{$x->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Edit Data Pertanian dan Peternakan</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form action="{{route('admin.updateAgri' , ['id'=>$x->id])}}" method="post">
                                    ...
                                    <div class="modal-body bg-white">
                                        ...
                                        <div class="form-group m-3">
                                            <label for="">Jenis</label>
                                            <select name="status" class="form-control" id="">
                                                <option @if($x->status == "Pertanian") selected @endif value="Pertanian">Pertanian</option>
                                                <option @if($x->status == "Peternakan") selected @endif value="Peternakan">Peternakan</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
