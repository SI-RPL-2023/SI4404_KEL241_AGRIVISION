...
@section('content')
    ...
    <div class="row">
        <div class="col card">
            ...
            <h1 class="text-center m-3">Pemetaan Provinsi</h1>
            ...
            <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{route('admin.storeProvinsi')}}" method="post">
                            @csrf
                            @method('post')
                    ...
                    @foreach($data as $x)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('admin.deleteProvinsi' , ['id'=>$x->id])}}" class="btn btn-danger"> Delete Data</a>
                            </td>
                        </tr>
                        ...
                        <div class="modal fade" id="edit{{$x->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{route('admin.updateProvinsi' , ['id'=>$x->id])}}" method="post">
                                        @csrf
                                        @method('put')
                                        <div class="modal-body bg-white">
                                            <div class="form-group m-3">
