...
<div class="page-header flex-wrap">
    <h3 class="mb-0"> AGRI VISION <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">RATAKAN PANGAN INDONESIA</span>
    </h3>
    <div class="d-flex">
        <button type="button" class="btn btn-sm bg-white btn-icon-text border">
            <i class="mdi mdi-email btn-icon-prepend"></i> Pesan </button>
        <button type="button" class="btn btn-sm bg-white btn-icon-text border ml-3">
            <i class="mdi mdi mdi-clipboard-alert btn-icon-prepend"></i> Request </button>
        <button type="button" class="btn btn-sm ml-3 btn-success"> Status </button>
    </div>
</div>
<div class="row">
                    ...
                    <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="color-card">
                                <p class="mb-0 color-card-head">Data Pemasok Pangan</p>
                                <h2 class="text-white">30 <span class="h5"></span>
                                </h2>
                            </div>
                            <i class="card-icon-indicator mdi mdi-basket bg-inverse-icon-warning"></i>
                        </div>
                        <h6 class="text-white">40.33% per Provinsi</h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                <div class="card bg-danger">
                    <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="color-card">
                                <p class="mb-0 color-card-head">Data Permintaan Pangan</p>
                                <h2 class="text-white"> 26<span class="h5"></span>
                                </h2>
                            </div>
                            <i class="card-icon-indicator mdi mdi-cube-outline bg-inverse-icon-danger"></i>
                        </div>
                        <h6 class="text-white">39.77% per Provinsi</h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3 pb-lg-0 pb-xl-3">
                <div class="card bg-primary">
                    <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="color-card">
                                <p class="mb-0 color-card-head">Data Permintaan Pasar</p>
                                <h2 class="text-white"> 5<span class="h5"></span>
                                </h2>
                            </div>
                            <i class="card-icon-indicator mdi mdi-briefcase-outline bg-inverse-icon-primary"></i>
                        </div>
                        <h6 class="text-white">20.05% per Wilayah</h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-12 col-md-6 stretch-card pb-sm-3 pb-lg-0">
                <div class="card bg-success">
                    <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="color-card">
                                <p class="mb-0 color-card-head">Data Permintaan Toko</p>
                                <h2 class="text-white">4</h2>
                            </div>
                            <i class="card-icon-indicator mdi mdi-account-circle bg-inverse-icon-success"></i>
                        </div>
                        <h6 class="text-white">20.32% per Wilayah</h6>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-9 stretch-card grid-margin">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-7">
                        <h5>Visualisasi Permintaan Pangan</h5>
                        <p class="text-muted"> Dari Jan 2021 - Dec 2022 <a class="text-muted font-weight-medium pl-2" href="#"><u>Detail</u></a>
                        </p>
                    </div>
                    <div class="col-sm-5 text-md-right">
                        <button type="button" class="btn btn-icon-text mb-3 mb-sm-0 btn-inverse-primary font-weight-normal">
                            <i class="mdi mdi-email btn-icon-prepend"></i>Download Laporan </button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card mb-3 mb-sm-0">
                            <div class="card-body py-3 px-4">
                                <p class="m-0 survey-head">Permintaan Pangan</p>
                                <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                                    <div>
                                        <h3 class="m-0 survey-value">20</h3>
                                        <p class="text-success m-0">per Provinsi</p>
                                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card mb-3 mb-sm-0">
                            <div class="card-body py-3 px-4">
                                <p class="m-0 survey-head">Permintaan Ditolak</p>
                                <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                                    <div>
                                        <h3 class="m-0 survey-value">5</h3>
                                        <p class="text-danger m-0">dari Permintaan</p>
                                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body py-3 px-4">
                                <p class="m-0 survey-head">Pengerjaan</p>
                                <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                                    <div>
                                        <h3 class="m-0 survey-value">1</h3>
                                        <p class="text-success m-0">Sedang Pengerjaan</p>
                                    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{url('images')}}/faces/face1.jpeg" alt="image" />
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{url('images')}}/faces/face10.jpg" alt="image" />
                                        <div class="table-user-name ml-3">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{url('images')}}/faces/face11.jpg" alt="image" />
                                        <div class="table-user-name ml-3">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{url('images')}}/faces/face13.jpg" alt="image" />
                                        <div class="table-user-name ml-3">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{url('images')}}/faces/face16.jpg" alt="image" />
                                        <div class="table-user-name ml-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                    <img class="survey-img mb-lg-3" src="{{url('images')}}/dashboard/img_3.jpg" alt="" />
                    <div class="pt-2">
                ...
                <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                    <img class="survey-img mb-lg-3" src="{{url('images')}}/dashboard/img_1.jpg" alt="" />
                    <div class="pt-2">
                ...
                <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                    <img class="survey-img mb-lg-3" src="{{url('images')}}/dashboard/img_2.jpg" alt="" />
                    <div class="pt-2">
            ...
            <div class="card-body">
                    ...
                    <div class="col-12 col-sm-7">
                        <div class="row">
                            <div class="col-4 col-md-4">
                                <img class="customer-img" src="{{url('images')}}/faces/face22.jpg" alt="" />
                            </div>
                    ...
                    <div class="col-sm-7">
                        <div class="row">
                            <div class="col-4 col-sm-4">
                                <img class="customer-img" src="{{url('images')}}/faces/face25.jpg" alt="" />
                            </div>
                ...
                <div class="row py-1">
                    <div class="col-sm-7">
                        <div class="row">
                            <div class="col-4 col-sm-4">
                                <img class="customer-img" src="{{url('images')}}/faces/face15.jpg" alt="" />
                            </div>
                            <div class="col-8 col-sm-8 p-sm-0">
                ...
                <div class="row py-1">
                    <div class="col-sm-7">
                        <div class="row">
                            <div class="col-4 col-sm-4">
                                <img class="customer-img" src="{{url('images')}}/faces/face5.jpg" alt="" />
                            </div>
                            <div class="col-8 col-sm-8 p-sm-0">
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <div class="row">
                            <div class="col-4 col-sm-4">
                                <img class="customer-img" src="{{url('images')}}/faces/face2.jpg" alt="" />
                            </div>
                            <div class="col-8 col-sm-8 p-sm-0">
            ...
            <div class="card-body">
                ...
                <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                    <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                            <img src="{{url('images')}}/dashboard/img_4.jpg" alt="" />
                            <div class="pl-2">
                ...
                <div class="row py-3 align-items-center mx-0">
                    <div class="col-sm-9 pl-0">
                        <div class="d-flex">
                            <img src="{{url('images')}}/dashboard/img_5.jpg" alt="" />
                            <div class="pl-2">
                        ...
                        <p class="text-muted">
                            ...
                            <span class="d-inline-block">
                                <span class="d-flex d-inline-block">
                                    <img class="ml-1" src="{{url('images')}}/faces/face1.jpeg" alt="" />
                                    <img class="ml-1" src="{{url('images')}}/faces/face10.jpg" alt="" />
                                    <img class="ml-1" src="{{url('images')}}/faces/face14.jpg" alt="" />
                                </span>
                            </span>
                        </p>
                    </li>
                ...
                <div class="list-card">
                    <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                            <div class="row align-items-center">
                                <div class="col-sm-4">
                                    <img src="{{url('images')}}/faces/face11.jpg" alt="" />
                                </div>
                                <div class="col-sm-8 pr-0 pl-sm-0">
            ...
            <div class="card-body">
                ...
                <div class="row py-2">
                    <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                            <div>
                                <img class="mr-2" src="{{url('images')}}/browser-logo/opera-logo.png" alt="" />
                ...
                <div class="row py-2">
                    <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                            <div>
                                <img class="mr-2" src="{{url('images')}}/browser-logo/safari-logo.png" alt="" />
                ...
                <div class="row py-2">
                    <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                            <div>
                                <img class="mr-2" src="{{url('images')}}/browser-logo/chrome-logo.png" alt="" />
                ...
                <div class="row py-2">
                    <div class="col-sm-12">
                        <div class="d-flex justify-content-between pb-3 border-bottom">
                            <div>
                                <img class="mr-2" src="{{url('images')}}/browser-logo/firefox-logo.png" alt="" />
                ...
                <div class="row py-2">
                    <div class="col-sm-12">
                        <div class="d-flex justify-content-between">
                            <div>
                                <img class="mr-2" src="{{url('images')}}/browser-logo/explorer-logo.png" alt="" />
