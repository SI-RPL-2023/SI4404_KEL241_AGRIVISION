        ...
        <div class="container">
            <div class="infos">
                ...
                <div class="buttons pt-3">
                    ...
                    <button class="btn btn-primary rounded" data-toggle="modal" data-target="#tambahNon">Request Non pangan</button> <br>
                    ...
                    <button class="btn btn-dark rounded mt-2" data-toggle="modal" data-target="#requestFood">Periksa Request Pangan</button>
                        ...
                        <button class="btn btn-dark rounded mt-2" data-toggle="modal" data-target="#requestNonFood">Periksa Request Non Pangan</button>
